...
const INSTAGRAM_URL = "https://instagram.com/cristalizevidros.ilhabela";

// ------- Ano dinâmico no footer -------
document.getElementById("year").textContent = new Date().getFullYear();

// ------- Botão flutuante WhatsApp -------
// Se WHATSAPP_NUMBER estiver preenchido, abre o chat direto.
// Caso contrário, mantém o link para a seção #contato (form).
const floatBtn = document.getElementById("floatBtn");
if (WHATSAPP_NUMBER && floatBtn) {
  ...
  if (WHATSAPP_NUMBER) {
    ...
    if (navigator.clipboard) {
      navigator.clipboard.writeText(texto).then(() => {
        ...
        alert("Entre em contato pelo nosso Instagram @cristalizevidros.ilhabela");
        window.open(INSTAGRAM_URL, "_blank");
      });
    } else {
      alert("Entre em contato pelo nosso Instagram @cristalizevidros.ilhabela");
